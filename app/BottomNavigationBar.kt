...
private fun createBottomNavigationItems(cartItemCount: Int): List<BottomNavigationItem>
{
    return listOf(
        BottomNavigationItem(
            ...
            route = AppScreenRoutes.ShoppingListOverviewScreenRoute.route,
            selectedIcon = Icons.AutoMirrored.Filled.List,
            unselectedIcon = Icons.AutoMirrored.Outlined.List
        ),
        BottomNavigationItem(
            title = "Produktsuche",
            route = AppScreenRoutes.ProductSearchScreenRoute.route,
            selectedIcon = Icons.Filled.Search,
            unselectedIcon = Icons.Outlined.Search
        ),
        BottomNavigationItem(
            title = "Mein Einkaufszettel",
            route = AppScreenRoutes.CartScreenRoute.route,
